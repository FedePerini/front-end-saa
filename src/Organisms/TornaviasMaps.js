...
export const TornaviasMaps = (props) => {
    ...
    return (
        <>
            ...
            {(props.floorNumber == 0) && <TornaviasPB showCardFunc={props.showCardFunc}></TornaviasPB>}
            {(props.floorNumber == 1) && <Tornavias1P showCardFunc={props.showCardFunc}></Tornavias1P>}
            {(props.floorNumber == -1) && <TornaviasSubSuelo showCardFunc={props.showCardFunc}></TornaviasSubSuelo>}
        </>
    )
}
